...
<body>
	...
	<div>
		<form:form action="/exercise/add" method="post" modelAttribute="newExercise">
		<form:input type="hidden" path="user" value="${user.id}"/>
			<table>
				<tbody>
					<tr>
						<td><form:label path="exerciseName">Exercise name: </form:label></td>
						<td><form:input path="exerciseName" type="text"/></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><form:input path="difficulty" type="number"/></td>
					</tr>
					<tr>
