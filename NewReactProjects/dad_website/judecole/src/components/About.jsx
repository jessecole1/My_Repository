...
import jude4 from '../aboutImg/jude4.png';
import jude5 from '../aboutImg/jude5.png';
import jude1 from '../aboutImg/jude1.png';
import jude3 from '../aboutImg/jude3.jpg';
            ...
            <div class="ml-32 mr-32">
                <div class="flex-col flex-wrap">
                    <div class="flex-wrap indent-5 text-left">
                        ...
                        <h3 class="indent-0 text-left text-2xl font-bold">EARLY CAREER</h3>
                        <p class="text-left">
                        ...
                        <img class="m-4 float-right" src={jude5}></img>
                        <h3 class="indent-0 text-left text-2xl font-bold">THE 80s</h3>
                        <p>
                        ...
                        <br></br>
                        <h3 class="indent-0 text-left text-2xl font-bold">THE 90s</h3>
                        <p>
                        ...
                        <br></br>
                        <img class="m-4 float-left" src={jude1}></img>
                        <h3 class="indent-0 text-left text-2xl font-bold">WARNER BROS. & ISLAND RECORDS</h3>
                        <p>
                        ...
                        <br></br>
                        <h3 class="indent-0 text-left text-2xl font-bold">EPIPHANIES</h3>
                        <p>
                        ...
                        <br></br>
                        <br></br>
                        <h3 class="indent-0 text-left text-2xl font-bold">LIFEHOUSE / PRODUCTION & MANAGEMENT</h3>
                        <p>
                        ...
                        <br></br>
                        <img class="m-4 float-right" src={jude3}></img>
                        <h3 class="indent-0 text-left text-2xl font-bold">IRONWORKS MUSIC</h3>
                        <p>
                        ...
                        <br></br>
                        <h3 class="indent-0 text-left text-2xl font-bold">2018, ETC...</h3>
                        <p>
